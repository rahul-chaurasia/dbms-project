...
<table border="0" width="100%" cellspacing="0" cellpadding="0" background="image/bluebar.png">
  <tr>
...
<div align="left" width=500 height=68 ></div>
	</td>
    <td width="10%">
     <img border="0" src="image/onlineexam.jpg" width="203" height="68" align="right">
	</td>
  </tr>
</table>
<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#000000" background="img/blackbar.jpg">
  ...
  <tr>
    <td width="100%" align="right"><img border="0" src="image/blackbar.jpg" width="89" height="17"></td>
  </tr>
  </Table>
  <Table width="100%">
  <tr>
